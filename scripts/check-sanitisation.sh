...
# nothing identifying may appear here is stated in CONTRIBUTING.md and PROJECT_NOTES.md,
# and a rule that is only stated is a rule that gets broken during a late-night
# edit. This turns it into a check.
#
...
#      PROJECT_NOTES.md once republished, in full, the values this check had
#      already scrubbed from the archived pages.
#
